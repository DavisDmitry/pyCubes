...
* Сериализаторы для [типов данных](https://wiki.vg/Data_types) (кроме: Chat, Entity Metadata, BitSet, Shunk Section (1.18) and Palleted container (1.18))
* Класс подключения
...
* [ ] Сериализаторы для всех типов данных
* [ ] Дескриптор пакетов
